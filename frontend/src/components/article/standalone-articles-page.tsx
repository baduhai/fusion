import { BookOpen, ExternalLink, Trash2, Plus, Star } from "lucide-react";
...
import {
  useStandaloneArticlesItems,
  useDeleteStandaloneArticle,
} from "@/queries/standalone-articles";
import {
  useBookmarkLookup,
  useCreateBookmark,
  useDeleteBookmark,
...
export function StandaloneArticlesPage() {
  const { t } = useI18n();
  const articles = useStandaloneArticlesItems();
  const deleteArticle = useDeleteStandaloneArticle();
        ...
        <ContentHeader>
          ...
          <div className="flex items-center gap-1.5 text-sm text-muted-foreground">
            ...
            <span className="font-medium">
              {t("standalone.count", { count: articles.length })}
            </span>
          </div>
        </ContentHeader>
