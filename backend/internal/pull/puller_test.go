...
<item><guid>g1</guid><title>Item</title><link>https://example.com/1</link></item>
	...
	feed, err := st.CreateFeed(1, "Feed A", server.URL, "", "", nil, false)
	if err != nil {
...
<item><guid>%s</guid><title>Item</title><link>https://example.com%s</link></item>
	...
	if _, err := st.CreateFeed(1, "Feed A", server.URL+"/a", "", "", nil, false); err != nil {
		t.Fatalf("create feed A: %v", err)
	}
	if _, err := st.CreateFeed(1, "Feed B", server.URL+"/b", "", "", nil, false); err != nil {
